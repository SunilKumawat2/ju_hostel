                              ...
                              <div className="row">
                                ...
                                <div className="col-md-6">
                                  <div className="input-group input-group-two left-icon mb-20">
                                    ...
                                    <input type="text" className="form-control" placeholder="College Register No" name="hostel_register_no" value={formdata.hostel_register_no} onChange={(e) => { handleChange(e) }} />
                                  </div>
                                </div>
                                <div className="col-md-6">
                                  <div className="input-group input-group-two left-icon mb-20">
